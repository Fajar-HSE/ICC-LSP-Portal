...
function tjcb_get_settings() {
    $def = [
        ...
        'system_prompt' => "Kamu adalah Asisten AI Training Jogja, lembaga pelatihan & sertifikasi (BNSP, Kemnaker, ISO, In House Training).\nAturan: jawab HANYA dari INFORMASI REFERENSI situs. Jika tidak ada di referensi, katakan jujur tidak tahu dan arahkan ke WhatsApp https://wa.me/6285328883511. Jangan mengarang harga, jadwal, atau link. Selalu jawab dalam Bahasa Indonesia, ramah dan ringkas.",
        ...
        'grounded'      => 1,
        'notfound_msg'  => 'Maaf, informasi tersebut belum tersedia di sistem kami. Silakan hubungi CS via WhatsApp 0853 2888 3511 atau email info@hseskillup.com.',
        'daily_cap'     => 50,
        'global_cap'    => 500,
        'rate_per_min'  => 10,
        'cost_guard'    => 1,
